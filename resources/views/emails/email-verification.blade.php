...
@section("root")
    <div style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; background-color: #f3f4f6;">
        ...
        'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; text-align: center; margin-top: 10px;">Email Verification</h3>
                </div>
            </div>
        ...
        'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-weight: 500;">To complete your registration, please verify your email address by clicking the button below:</p>
                <a href="{{ $url }}" style="display: inline-block; background-color: #3F00E7; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; margin-top: 20px; font-family: sans-serif; font-weight: 600;">Verify Email</a>
